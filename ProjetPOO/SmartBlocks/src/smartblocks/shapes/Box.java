...
public strictfp class Box implements Shape{
    ...
    /**
     * Distance of the upper-left corner of this box to the
     * origin of the world's coordinate system aka computer screen
     */
    protected Vector2D offset;

    /**
     * Width (size.x) and height (size.y) of this block
     */
    protected Vector2D size;

    /**
     * Coordinates of the center of this Box with respect to the upper-left corner of this box
     */
    protected Vector2D centroid;

    /**
     * The four vertices of this Box, being the first one its the upper-left corner
     * and following then counterclockwise
     */
    protected Vector2D[] vertices;

    /**
     * Angle of rotation of this Box
     */
    protected float angle;

    /**
     * Area of this Box = width*height
     */
    ...
    public boolean overlaps(Shape other) {
            ...
            return (totalWidth > dx+0.005f) && (totalHeight > dy+0.005f);
    }
