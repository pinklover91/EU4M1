...
/**
 * A polygon enclosed in a Circle and with a Box as bounds
...
public strictfp class Polygon extends Circle {
	...
	public Polygon(Vector2D offset, Vector2D[] v) {
        ...
        /**
         * Initializes Circle-like attributes
         * @param center
         * @param r
         */
	 ...
	 * 
	 * @return radius of the circle in which this polygon is circumscribed
	 */
	...
	public boolean isConvex() {
         ...
         * @return array of vertices, expressed with respect to this shape's centroid
         */
        @Override
